...
-- Galaxy Locations
GALAXY_LOCATION_BASIC_DECK  = LOCATION_DECK --卡组
GALAXY_LOCATION_HAND_CARDS  = LOCATION_HAND --手牌
GALAXY_LOCATION_UNIT_ZONE	= LOCATION_MZONE --单位区
GALAXY_LOCATION_SUPPORT_ZONE	= LOCATION_SZONE	--支援区
GALAXY_LOCATION_DISCARD   = LOCATION_GRAVE   --弃牌区
GALAXY_LOCATION_EXILED	= LOCATION_REMOVED  --游戏外
GALAXY_LOCATION_SPECIAL_DECK	= LOCATION_EXTRA	--特殊卡组
...
-- Galaxy Types
GALAXY_TYPE_UNIT		= TYPE_MONSTER  --单位
GALAXY_TYPE_SUPPORT  = TYPE_SPELL	 --支援
GALAXY_TYPE_TACTICS  = TYPE_TRAP		 --战术
--GALAXY_TYPE_GENERAL   = TYPE_NORMAL   --一般
GALAXY_TYPE_FORCES  = TYPE_EFFECT   --部队
GALAXY_TYPE_LARGE	= TYPE_FUSION  --大型
GALAXY_TYPE_FACILITY	= TYPE_CONTINUOUS   --设施
GALAXY_TYPE_AREA		= TYPE_FIELD		--区域
GALAXY_TYPE_ENHANCEMENT = TYPE_EQUIP		--强化
GALAXY_TYPE_QUICK	= TYPE_QUICK   --快速
GALAXY_TYPE_COUNTER  = TYPE_COUNTER   --反制
--Attributes 属性
...
-- Galaxy Phase
GALAXY_PHASE_SUPPLY   = PHASE_DRAW   --补给阶段
GALAXY_PHASE_PREPARATION	= PHASE_STANDBY --战备阶段
GALAXY_PHASE_DEPLOY   = PHASE_MAIN1   --部署阶段
GALAXY_PHASE_COMBAT   = PHASE_BATTLE  --交战阶段
GALAXY_PHASE_ORGANIZE	= PHASE_MAIN2   --整备阶段
GALAXY_PHASE_REST		= PHASE_END   --休整阶段
--Player	--玩家
